...
def sort_cores(centroids, cluster_assignments, data, K):
    ...
    near_pairs = set_the_nearest_vectors(0, 1, centroids=centroids, cluster_assignments=cluster_assignments, data=data, K)
    ...
    for i, core1 in enumerate(centroids[:-1]):
        for j, core2 in enumerate(centroids[i + 1:]):
            near_pairs = set_the_nearest_vectors(i, i + j + 1, centroids=centroids, cluster_assignments=cluster_assignments, data=data,K)
